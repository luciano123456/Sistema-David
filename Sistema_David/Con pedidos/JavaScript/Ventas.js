...
$(document).ready(function () {
    ...
    configurarDataTable(-1, FechaDesde, FechaHasta, FechaLimiteDesde, FechaLimiteHasta, VentaFinalizada);
...
function aplicarFiltros() {
    ...
    configurarDataTable(idVendedor, document.getElementById("FechaDesde").value, document.getElementById("FechaHasta").value, document.getElementById("FechaLimiteDesde").value, document.getElementById("FechaLimiteHasta").value, document.getElementById("VentaFinalizada").checked ? 1 : 0);
...
const configurarDataTable = async (idVendedor, fechaDesde, fechaHasta, fechaLimiteDesde, fechaLimiteHasta, Finalizadas) => {
    gridVentas = $('#grdVentas').DataTable({
        "ajax": {
            "url": `/Ventas/Listar?idVendedor=${idVendedor}&FechaDesde=${fechaDesde}&FechaHasta=${fechaHasta}&FechaLimiteDesde=${fechaLimiteDesde}&FechaLimiteHasta=${fechaLimiteHasta}&Finalizadas=${Finalizadas}`,
            "type": "GET",
            "dataType": "json"
        },
        "language": {
